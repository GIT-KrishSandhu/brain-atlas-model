"""
Writer script — writes DATA_SURVEY.md, ENVIRONMENT_AUDIT.md to reports/data_survey/
"""
import pathlib
...
DATA_SURVEY = r"""# TopAneu-26 Data Discovery & Pre-Baseline Model Readiness Audit
...
with open(OUT / "DATA_SURVEY.md", "w", encoding="utf-8") as f:
    f.write(DATA_SURVEY)
print("Wrote DATA_SURVEY.md")
...
with open(OUT / "ENVIRONMENT_AUDIT.md", "w", encoding="utf-8") as f:
    f.write(ENVIRONMENT_AUDIT)
print("Wrote ENVIRONMENT_AUDIT.md")
print("Done.")
